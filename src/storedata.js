...
export class Data extends LitElement {
    ...
    render(){
            ...
            ${repeat(
                ...
                <tr >
                       <td>${item.name}</td>
                        ...
                        <td>${item.zipcode}</td>
                        <td id="btn">
                        <button class="update" @click=${() => this.edit(index)}>Edit</button>
                        &nbsp &nbsp
                        <button class="delete" @click=${() => this.delete(index)}>Delete</button>
                        </td>
        ...
        <form method="dialog">
          ...
          /></label><br>
          <center><button id="c1" @click=${this.cancelData}>Cancel</button><br><br>
          <button id="s1" @click=${this.updateData} type="submit">Update</button><center>
        </form>
      </dialog>
    ...
    static get styles(){
        ...
        tr:hover{background-color:#72d35550}
        tr:nth-child(even){background-color:#e6eaf0}
